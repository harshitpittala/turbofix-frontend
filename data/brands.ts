...
export const brandData: BrandData[] = [
  {
    ...
    commonIssues: [
      ...
      { title: "Charging Port / Lightning Issues", desc: "Lightning and USB-C port cleaning and replacement. Fast charge functionality tested.", time: "25–35 min" },
      ...
      { title: "Camera Module Service", desc: "Front and rear camera service. Ultra-wide, telephoto, and macro systems handled. OIS module service.", time: "40–50 min" },
      { title: "Speaker / Microphone Issues", desc: "Earpiece, loudspeaker, and microphone module replacement. Audio tested post-service.", time: "25–35 min" },
    ],
    faqs: [
      ...
      { q: "Will Face ID still work after iPhone screen replacement?", a: "Yes — our technicians are trained to handle Face ID components with care during screen replacements. We test Face ID after every screen service." },
      { q: "How long does an iPhone screen replacement take?", a: "iPhone screen replacements take 30–45 minutes including our full post-service quality check." },
      { q: "Does TurboFix service all iPhone models in Hyderabad?", a: "Yes — we service all iPhone models from iPhone SE to the latest iPhone 15 Pro Max." },
    ],
    keywords: ["iPhone service Hyderabad", "iPhone screen replacement", "iPhone battery replacement", "Apple service Hyderabad", "iPhone service near me"],
  },
  {
    slug: "samsung",
    name: "Samsung Galaxy",
    ...
    commonIssues: [
      ...
      { title: "Charging Port (USB-C) Service", desc: "USB-C port cleaning and module replacement. Fast charge, data transfer tested.", time: "25–40 min" },
      { title: "Samsung Foldable Screen Service", desc: "Z Fold and Z Flip ultra-thin glass replacement. Specialized training required. Complex job — please contact us.", time: "2–4 hrs" },
      { title: "Back Glass / Back Cover Replacement", desc: "Rear glass or cover replacement for all Samsung models. Camera ring and NFC re-sealed.", time: "40–60 min" },
      { title: "Water Damage Service", desc: "PCB ultrasonic cleaning, component-level inspection. 85% success rate on phones within 24 hours.", time: "2–4 hrs" },
    ],
    faqs: [
      { q: "Does the in-display fingerprint sensor work after Samsung screen service?", a: "Yes — we test and calibrate the in-display fingerprint sensor after every Samsung screen replacement." },
      { q: "Can TurboFix service Samsung Galaxy Z Fold and Z Flip?", a: "Yes — foldable service requires advance booking as it's more complex. Please WhatsApp or call us to arrange." },
    ...
    keywords: ["Samsung service Hyderabad", "Samsung Galaxy screen service", "Samsung battery replacement", "Samsung Galaxy Hyderabad", "Samsung service near me"],
  },
  {
    slug: "oneplus",
    name: "OnePlus",
    ...
    commonIssues: [
      ...
      { title: "Warp / SuperVOOC Charging Port", desc: "Warp Charge port service and replacement. Full fast-charge speed restored.", time: "30–40 min" },
      { title: "Camera System Service", desc: "Hasselblad-tuned rear camera module replacement. Ultra-wide and telephoto included.", time: "40–55 min" },
      { title: "Back Glass Replacement", desc: "OnePlus textured and glass back replacement. All color variants.", time: "35–50 min" },
    ],
    faqs: [
      { q: "Does TurboFix service OnePlus Nord series?", a: "Yes — we service all OnePlus Nord models including CE 2, CE 3, CE 4, Nord 2, Nord 3, and Nord 4." },
    ...
    keywords: ["OnePlus service Hyderabad", "OnePlus screen service", "OnePlus battery replacement", "OnePlus Nord service", "OnePlus Hyderabad"],
  },
  {
    slug: "xiaomi",
    ...
    commonIssues: [
      ...
      { title: "Battery Replacement", desc: "High-capacity battery replacement. HyperCharge fast charging tested post-service.", time: "20–30 min" },
      { title: "Charging Port Service", desc: "USB-C port service for Xiaomi/Redmi/POCO. Fast charge functionality verified.", time: "25–35 min" },
      { title: "Camera Module Service", desc: "Leica-tuned camera service on flagship models. Periscope telephoto and ultra-wide handling.", time: "40–55 min" },
    ],
    faqs: [
      { q: "Does TurboFix service Redmi Note series phones?", a: "Yes — Redmi Note series is one of our most serviced lineups. We stock parts for all popular Note models." },
      { q: "Can you service POCO phones in Hyderabad?", a: "Yes — all POCO models including F series, X series, and M series." },
    ],
    keywords: ["Xiaomi service Hyderabad", "Redmi service Hyderabad", "POCO service", "Xiaomi screen service", "Redmi Note service Hyderabad"],
  },
  {
    slug: "vivo",
    name: "Vivo",
    ...
    commonIssues: [
      ...
      { title: "Battery Replacement", desc: "FlashCharge battery replacement. Charging speed tested post-service.", time: "25–35 min" },
      { title: "Camera Module Service", desc: "ZEISS-tuned and standard camera module replacement. Gimbal stabilization tested.", time: "40–55 min" },
      { title: "Charging Port Service", desc: "USB-C port service for all Vivo models including iQOO series.", time: "25–40 min" },
    ],
    faqs: [
      { q: "Does TurboFix service iQOO phones?", a: "Yes — iQOO is Vivo's sub-brand and we service all iQOO models." },
    ...
    keywords: ["Vivo service Hyderabad", "Vivo screen service", "Vivo battery replacement", "iQOO service Hyderabad", "Vivo service near me"],
  },
  {
    slug: "oppo",
    name: "Oppo",
    ...
    commonIssues: [
      ...
      { title: "VOOC / SuperVOOC Charging Port", desc: "VOOC and SuperVOOC charging port service. Full fast-charge speed verified.", time: "25–40 min" },
      { title: "Battery Replacement", desc: "High-capacity battery replacement. SuperVOOC fast charge tested.", time: "20–35 min" },
      { title: "Hasselblad / Standard Camera Service", desc: "Find X series Hasselblad cameras and standard modules serviced.", time: "40–55 min" },
    ],
    faqs: [
      { q: "Does TurboFix service Oppo Reno series?", a: "Yes — all Oppo Reno models are serviced at TurboFix Hyderabad." },
      { q: "Can you resolve VOOC charging that has stopped working?", a: "Yes — VOOC/SuperVOOC charging issues are usually port or cable related. We diagnose and service charging systems for all Oppo models." },
    ],
    keywords: ["Oppo service Hyderabad", "Oppo Reno service", "Oppo screen service", "VOOC charging service", "Oppo service near me"],
  },
  {
    slug: "realme",
    name: "Realme",
    ...
    commonIssues: [
      ...
      { title: "Battery Replacement", desc: "SUPERVOOC battery replacement. Fast charging speed tested after service.", time: "20–30 min" },
      { title: "Charging Port Service", desc: "USB-C port service and replacement. SUPERVOOC compatibility tested.", time: "20–35 min" },
      { title: "Speaker Service", desc: "Stereo speaker replacement. Dolby Atmos tuning preserved.", time: "20–30 min" },
      { title: "Back Glass / Cover Replacement", desc: "Textured and glass back replacement. All color variants.", time: "25–40 min" },
    ],
    faqs: [
      { q: "Is Realme affordable to service?", a: "Yes — Realme parts are widely available in India, keeping service costs accessible. Screen replacements for most Realme models cost less than flagship brands." },
      { q: "Does TurboFix service Realme Narzo series?", a: "Yes — all Realme Narzo models are covered at TurboFix." },
    ],
    keywords: ["Realme service Hyderabad", "Realme screen service", "Realme battery replacement", "Realme Narzo service", "Realme service near me"],
  },
  {
    slug: "motorola",
    name: "Motorola",
    ...
    commonIssues: [
      ...
      { title: "Charging Port Service", desc: "USB-C port service. TurboPower fast charge verified.", time: "25–40 min" },
      { title: "Motorola Razr Foldable Service", desc: "Razr series foldable screen and hinge service. Contact us for specific availability.", time: "2–4 hrs" },
    ],
    faqs: [
      { q: "Does TurboFix service Moto G series phones?", a: "Yes — Moto G series is one of our most serviced Android lineups. We stock parts for all current Moto G models." },
      { q: "Can you service Motorola Razr foldable phones?", a: "Yes — Razr service requires advance booking. Please contact us before bringing in a foldable Razr." },
    ],
    keywords: ["Motorola service Hyderabad", "Moto G service", "Motorola screen service", "Motorola Edge service", "Motorola Razr service Hyderabad"],
  },
  {
    slug: "google-pixel",
    name: "Google Pixel",
    ...
    commonIssues: [
      ...
      { title: "Camera Module Service", desc: "Pixel's computational photography cameras require careful module replacement and focus calibration.", time: "40–60 min" },
    ...
    faqs: [
      ...
      { q: "Does Pixel's under-display fingerprint work after screen service?", a: "Yes — we calibrate the in-display fingerprint sensor as part of every Pixel screen replacement." },
    ],
    keywords: ["Google Pixel service Hyderabad", "Pixel screen service", "Pixel battery replacement", "Pixel 8 service", "Google Pixel Hyderabad"],
  },
  {
    slug: "nothing",
    name: "Nothing Phone",
    ...
    commonIssues: [
      ...
      { title: "Glyph Interface Service", desc: "Glyph LED strip service and reconnection. Unique expertise required for the distinctive LED system.", time: "40–60 min" },
      { title: "Transparent Back Replacement", desc: "Nothing's signature transparent back panel replacement with care for the aesthetic design.", time: "35–50 min" },
      { title: "Charging Port Service", desc: "USB-C port service. 45W fast charging tested.", time: "25–40 min" },
    ],
    faqs: [
      { q: "Can TurboFix service the Glyph Interface on Nothing Phone?", a: "Yes — Glyph LED service is a specialized offering we provide. We test all Glyph notification zones after service." },
      { q: "Is Nothing Phone (2) hard to service?", a: "Nothing Phone uses a more standard Android architecture, making most service comparable in complexity to similar OLED devices." },
    ],
    keywords: ["Nothing Phone service Hyderabad", "Nothing Phone screen service", "Glyph service", "Nothing Phone 2 service", "Nothing service near me"],
  },
];
