...
import BookRepairClient from "../book-repair/BookRepairClient";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://turbofix.in/book-a-visit",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Book a Visit", item: "https://turbofix.in/book-a-visit" },
  ],
};
...
export default function BookVisitPage() {
  return (
    <>
      <JsonLd schema={faqSchema} id="schema-faq-book-a-visit" />
      <JsonLd schema={breadcrumbSchema} id="schema-breadcrumb-book-a-visit" />
      <BookRepairClient />
    </>
  );
}
