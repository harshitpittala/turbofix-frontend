...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Is doorstep mobile repair safe?", acceptedAnswer: { "@type": "Answer", text: "Yes — our technicians are certified, background-verified, and carry professional equipment. Your device is covered by our service guarantee throughout the repair." } },
